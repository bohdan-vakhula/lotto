...
class PlayLottery extends Data
{
    ...
    public function insertNavidadNumbers()
    {
        ...
        // El-Nino and Valentine
        if ($this->postData['productID'] == 24 || $this->postData['productID'] == 26) {
            $this->processedData['lotteryTypeID'] = $this->postData['productID'];
        }
    }

    public function getMemberFreeTicket()
    {
        $this->processedData = array(
            'MemberId'   => $_SESSION['user_data']['MemberId'],
            'BrandID'    => BRAND_ID,
